...
```json
{
  "projectName" : "mu-tanzu-app",
  "repositoryPrefix" : "harbor.vrabbi.cloud"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->mu-tanzu-app]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.transformations[0].sources[1].delegate.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->harbor.vrabbi.cloud]
